...
const CountrieBanner: FC<CountrieProps> = ({
  ...
  const style = {
    bgImage: ` mt-[2em]  mb-[5em] w-full h-[40vh] md:h-[60vh]  bg-cover bg-center bg-no-repeat relative bg-fixed object-content z-50`,
    ...
    description: `text-[0.9rem] text-[#0D304A]  tracking-wide uppercase md:text-xl lg:text-2xl hidden md:flex`,
    play: ``,
    hr: `hidden lg:flex bg-white h-[1.2px] w-[15rem]`,
    textInner: `flex items-center w-[50vw] md:w-[40vw] jusstify-center`,
    btn: ` w-full text-center uppercase font-light md:tracking-widest ml-5 bg-[#0D304A] rounded-full py-2 px-3 md:py-[1rem] w-100 md:px-[1rem] border-[1px] md:border-[2px]  `,
