...
const style = {
  container: ` flex flex-1  bg-white border-[2px]  justify-center items-center flex-col rounded-md py-5  min-height-[110px]`,
  textContainer: `text-center  flex flex-col`,
  title: `text-[#808191] text-[16px] capitalize`,
